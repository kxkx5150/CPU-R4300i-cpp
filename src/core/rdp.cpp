...
#define rsp_imem               ((uint32_t *)(n64->rsp.mem + 0x1000))
#define rsp_dmem               ((uint32_t *)n64->rsp.mem)
#define rdram                  ((uint32_t *)n64->ri.ram)
#define rdram16                ((uint16_t *)n64->ri.ram)
#define rdram8                 (n64->ri.ram)
#define vi_width               (n64->vi.regs[VI_WIDTH_REG])
#define dp_start               (n64->rdp.regs[DPC_START_REG])
#define dp_end                 (n64->rdp.regs[DPC_END_REG])
#define dp_current             (n64->rdp.regs[DPC_CURRENT_REG])
#define dp_status              (n64->rdp.regs[DPC_STATUS_REG])
...
int read_dp_regs(void *opaque, uint32_t address, uint32_t *word)
{
    ...
    enum dp_register reg    = (dp_register)(offset >> 2);
    *word                   = rdp->regs[reg];
...
static int       ti_format  = 0;
static int       ti_size    = 0;
...
static void fetch_texel_quadro(COLOR *color0, COLOR *color1, COLOR *color2, COLOR *color3, int s0, int s1, int t0,
                               int t1, uint32_t tilenum);
static void fetch_texel_entlut_quadro(COLOR *color0, COLOR *color1, COLOR *color2, COLOR *color3, int s0, int s1,
                                      int t0, int t1, uint32_t tilenum);
...
static void get_tmem_idx(int s, int t, uint32_t tilenum, uint32_t *idx0, uint32_t *idx1, uint32_t *idx2, uint32_t *idx3,
...
static void sort_tmem_shorts_lowhalf(uint32_t *bindshort, uint32_t short0, uint32_t short1, uint32_t short2,
...
static void read_tmem_copy(int s, int s1, int s2, int s3, int t, uint32_t tilenum, uint32_t *sortshort, int *hibits,
                           int *lowbits);
static void replicate_for_copy(uint32_t *outbyte, uint32_t inshort, uint32_t nybbleoffset, uint32_t tilenum,
                               uint32_t tformat, uint32_t tsize);
...
static inline int  blender_1cycle(uint32_t *fr, uint32_t *fg, uint32_t *fb, int dith, uint32_t blend_en,
                                  uint32_t prewrap, uint32_t curpixel_cvg, uint32_t curpixel_cvbit);
static inline int  blender_2cycle(uint32_t *fr, uint32_t *fg, uint32_t *fb, int dith, uint32_t blend_en,
                                  uint32_t prewrap, uint32_t curpixel_cvg, uint32_t curpixel_cvbit, int32_t acalpha);
static inline void texture_pipeline_cycle(COLOR *TEX, COLOR *prev, int32_t SSS, int32_t SST, uint32_t tilenum,
                                          uint32_t cycle);
static inline void tc_pipeline_copy(int32_t *sss0, int32_t *sss1, int32_t *sss2, int32_t *sss3, int32_t *sst,
                                    int tilenum);
static inline void tc_pipeline_load(int32_t *sss, int32_t *sst, int tilenum, int coord_quad);
static inline void tcclamp_generic(int32_t *S, int32_t *T, int32_t *SFRAC, int32_t *TFRAC, int32_t maxs, int32_t maxt,
                                   int32_t num);
static inline void tcclamp_cycle(int32_t *S, int32_t *T, int32_t *SFRAC, int32_t *TFRAC, int32_t maxs, int32_t maxt,
                                 int32_t num);
...
__attribute__((cold)) static void precalculate_everything(void);
...
static void fbwrite_4(uint32_t curpixel, uint32_t r, uint32_t g, uint32_t b, uint32_t blend_en, uint32_t curpixel_cvg,
                      uint32_t curpixel_memcvg);
static void fbwrite_8(uint32_t curpixel, uint32_t r, uint32_t g, uint32_t b, uint32_t blend_en, uint32_t curpixel_cvg,
                      uint32_t curpixel_memcvg);
static void fbwrite_16(uint32_t curpixel, uint32_t r, uint32_t g, uint32_t b, uint32_t blend_en, uint32_t curpixel_cvg,
                       uint32_t curpixel_memcvg);
static void fbwrite_32(uint32_t curpixel, uint32_t r, uint32_t g, uint32_t b, uint32_t blend_en, uint32_t curpixel_cvg,
                       uint32_t curpixel_memcvg);
...
__attribute__((cold)) static void z_build_com_table(void);
__attribute__((cold)) static void precalc_cvmask_derivatives(void);

static inline uint16_t decompress_cvmask_frombyte(uint8_t byte);

static inline void     lookup_cvmask_derivatives(uint32_t mask, uint8_t *offx, uint8_t *offy, uint32_t *curpixel_cvg,
                                                 uint32_t *curpixel_cvbit);
static inline void     z_store(uint32_t zcurpixel, uint32_t z, int dzpixenc);
static inline uint32_t z_compare(uint32_t zcurpixel, uint32_t sz, uint16_t dzpix, int dzpixenc, uint32_t *blend_en,
...
static inline void     video_filter16(int *r, int *g, int *b, uint32_t fboffset, uint32_t num, uint32_t hres,
                                      uint32_t centercvg, uint32_t fetchstate);
static inline void     video_filter32(int *endr, int *endg, int *endb, uint32_t fboffset, uint32_t num, uint32_t hres,
                                      uint32_t centercvg, uint32_t fetchstate);
...
static inline void tclod_4x17_to_15(int32_t scurr, int32_t snext, int32_t tcurr, int32_t tnext, int32_t previous,
                                    int32_t *lod);
static inline void tclod_tcclamp(int32_t *sss, int32_t *sst);
static inline void lodfrac_lodtile_signals(int lodclamp, int32_t lod, uint32_t *l_tile, uint32_t *magnify,
                                           uint32_t *distant, int32_t *lfdst);

static inline void tclod_1cycle_current(int32_t *sss, int32_t *sst, int32_t nexts, int32_t nextt, int32_t s, int32_t t,
                                        int32_t w, int32_t dsinc, int32_t dtinc, int32_t dwinc, int32_t scanline,
                                        int32_t prim_tile, int32_t *t1, SPANSIGS *sigs);
static inline void tclod_1cycle_current_simple(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w,
                                               int32_t dsinc, int32_t dtinc, int32_t dwinc, int32_t scanline,
                                               int32_t prim_tile, int32_t *t1, SPANSIGS *sigs);
static inline void tclod_1cycle_next(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w, int32_t dsinc,
                                     int32_t dtinc, int32_t dwinc, int32_t scanline, int32_t prim_tile, int32_t *t1,
                                     SPANSIGS *sigs, int32_t *prelodfrac);
static inline void tclod_2cycle_current(int32_t *sss, int32_t *sst, int32_t nexts, int32_t nextt, int32_t s, int32_t t,
                                        int32_t w, int32_t dsinc, int32_t dtinc, int32_t dwinc, int32_t prim_tile,
                                        int32_t *t1, int32_t *t2);
static inline void tclod_2cycle_current_simple(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w,
                                               int32_t dsinc, int32_t dtinc, int32_t dwinc, int32_t prim_tile,
                                               int32_t *t1, int32_t *t2);
static inline void tclod_2cycle_current_notexel1(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w,
                                                 int32_t dsinc, int32_t dtinc, int32_t dwinc, int32_t prim_tile,
                                                 int32_t *t1);
static inline void tclod_2cycle_next(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w, int32_t dsinc,
                                     int32_t dtinc, int32_t dwinc, int32_t prim_tile, int32_t *t1, int32_t *t2,
                                     int32_t *prelodfrac);
static inline void tclod_copy(int32_t *sss, int32_t *sst, int32_t s, int32_t t, int32_t w, int32_t dsinc, int32_t dtinc,
                              int32_t dwinc, int32_t prim_tile, int32_t *t1);

static inline void get_texel1_1cycle(int32_t *s1, int32_t *t1, int32_t s, int32_t t, int32_t w, int32_t dsinc,
                                     int32_t dtinc, int32_t dwinc, int32_t scanline, SPANSIGS *sigs);
static inline void get_nexttexel0_2cycle(int32_t *s1, int32_t *t1, int32_t s, int32_t t, int32_t w, int32_t dsinc,
...
static inline void vi_fetch_filter16(CCVG *res, uint32_t fboffset, uint32_t cur_x, uint32_t fsaa,
                                     uint32_t dither_filter, uint32_t vres, uint32_t fetchstate);
static inline void vi_fetch_filter32(CCVG *res, uint32_t fboffset, uint32_t cur_x, uint32_t fsaa,
                                     uint32_t dither_filter, uint32_t vres, uint32_t fetchstate);

__attribute__((cold)) static uint32_t vi_integer_sqrt(uint32_t a);
__attribute__((cold)) static void     deduce_derivatives(void);
...
static void (*vi_fetch_filter_func[2])(CCVG *, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
                                       uint32_t)                = {vi_fetch_filter16, vi_fetch_filter32};
static void (*fbread_func[4])(uint32_t, uint32_t *)             = {fbread_4, fbread_8, fbread_16, fbread_32};
static void (*fbread2_func[4])(uint32_t, uint32_t *)            = {fbread2_4, fbread2_8, fbread2_16, fbread2_32};
static void (*fbwrite_func[4])(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
                               uint32_t)                        = {fbwrite_4, fbwrite_8, fbwrite_16, fbwrite_32};
static void (*fbfill_func[4])(uint32_t)                         = {fbfill_4, fbfill_8, fbfill_16, fbfill_32};
static void (*get_dither_noise_func[3])(int, int, int *, int *) = {get_dither_noise_complete, get_dither_only,
                                                                   get_dither_nothing};
static void (*rgb_dither_func[2])(int *, int *, int *, int)     = {rgb_dither_complete, rgb_dither_nothing};
...
static void (*render_spans_2cycle_func[4])(int, int, int,
                                           int) = {render_spans_2cycle_notex, render_spans_2cycle_notexel1,
                                                   render_spans_2cycle_notexelnext, render_spans_2cycle_complete};
...
__attribute__((cold)) int angrylion_rdp_init(struct n64_device *device)
{
    n64 = device;
    if (0)
    ...
    idxlim16 = 0x3fffff;
    idxlim32 = 0x1fffff;
    rdram_8  = (uint8_t *)((uint32_t *)n64->ri.ram);
    rdram_16 = (uint16_t *)((uint32_t *)n64->ri.ram);
    return 0;
}
static inline void vi_fetch_filter16(CCVG *res, uint32_t fboffset, uint32_t cur_x, uint32_t fsaa,
                                     uint32_t dither_filter, uint32_t vres, uint32_t fetchstate)
{
    ...
    if (fsaa) {
        {
            (idx) &= (0x007fffff >> 1);
            if ((idx) <= idxlim16) {
                (pix)  = ((uint16_t)(((uint8_t)(rdram_16[(idx)] >> 8)) | ((uint16_t)(rdram_16[(idx)] << 8))));
                (hval) = hidden_bits[(idx)];
            } else {
                (pix) = (hval) = 0;
            }
        };
    ...
    } else {
        {
            (idx) &= (0x007fffff >> 1);
            (pix) = ((idx) <= idxlim16)
                        ? (((uint16_t)(((uint8_t)(rdram_16[(idx)] >> 8)) | ((uint16_t)(rdram_16[(idx)] << 8)))))
                        : 0;
        };
        cur_cvg = 7;
    }
    ...
    g            = (((pix)&0x7c0) >> 3);
    b            = (((pix)&0x3e) << 2);
    uint32_t fbw = (n64->vi.regs[VI_WIDTH_REG]) & 0xfff;
    if (cur_cvg == 7) {
        if (dither_filter)
                                     ...
                                     uint32_t dither_filter, uint32_t vres, uint32_t fetchstate)
{
    ...
    {
        (addr) &= (0x007fffff >> 2);
        (pix) = ((addr) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(addr)])) : 0;
    };
    uint32_t cur_cvg;
    if (fsaa)
        cur_cvg = (pix >> 5) & 7;
...
static inline void combiner_1cycle(int adseed, uint32_t *curpixel_cvg)
{
    ...
    if (combiner_rgbmul_r[1] != &zero_color) {
        combined_color.r = color_combiner_equation(*combiner_rgbsub_a_r[1], *combiner_rgbsub_b_r[1],
                                                   *combiner_rgbmul_r[1], *combiner_rgbadd_r[1]);
        combined_color.g = color_combiner_equation(*combiner_rgbsub_a_g[1], *combiner_rgbsub_b_g[1],
                                                   *combiner_rgbmul_g[1], *combiner_rgbadd_g[1]);
        combined_color.b = color_combiner_equation(*combiner_rgbsub_a_b[1], *combiner_rgbsub_b_b[1],
                                                   *combiner_rgbmul_b[1], *combiner_rgbadd_b[1]);
    } else {
    ...
    if (combiner_alphamul[1] != &zero_color)
        combined_color.a = alpha_combiner_equation(*combiner_alphasub_a[1], *combiner_alphasub_b[1],
                                                   *combiner_alphamul[1], *combiner_alphaadd[1]);
    else
    ...
    if (!other_modes.key_en) {
        ...
        redkey = (((combined_color.r) & ((1 << 17) - 1)) | -((combined_color.r) & (1 << (17 - 1))));
        if (redkey >= 0)
            redkey = (key_width.r << 4) - redkey;
        else
            redkey = (key_width.r << 4) + redkey;
        greenkey = (((combined_color.g) & ((1 << 17) - 1)) | -((combined_color.g) & (1 << (17 - 1))));
        if (greenkey >= 0)
            greenkey = (key_width.g << 4) - greenkey;
        else
            greenkey = (key_width.g << 4) + greenkey;
        bluekey = (((combined_color.b) & ((1 << 17) - 1)) | -((combined_color.b) & (1 << (17 - 1))));
        if (bluekey >= 0)
...
static inline void combiner_2cycle(int adseed, uint32_t *curpixel_cvg, int32_t *acalpha)
{
    ...
    if (combiner_rgbmul_r[0] != &zero_color) {
        combined_color.r = color_combiner_equation(*combiner_rgbsub_a_r[0], *combiner_rgbsub_b_r[0],
                                                   *combiner_rgbmul_r[0], *combiner_rgbadd_r[0]);
        combined_color.g = color_combiner_equation(*combiner_rgbsub_a_g[0], *combiner_rgbsub_b_g[0],
                                                   *combiner_rgbmul_g[0], *combiner_rgbadd_g[0]);
        combined_color.b = color_combiner_equation(*combiner_rgbsub_a_b[0], *combiner_rgbsub_b_b[0],
                                                   *combiner_rgbmul_b[0], *combiner_rgbadd_b[0]);
    } else {
    ...
    if (combiner_alphamul[0] != &zero_color)
        combined_color.a = alpha_combiner_equation(*combiner_alphasub_a[0], *combiner_alphasub_b[0],
                                                   *combiner_alphamul[0], *combiner_alphaadd[0]);
    else
...
static void SET_BLENDER_INPUT(int cycle, int which, int32_t **input_r, int32_t **input_g, int32_t **input_b,
...
static void fetch_texel(COLOR *color, int s, int t, uint32_t tilenum)
{
    ...
    switch (tile[tilenum].f.notlutswitch) {
        ...
        case 2: {
            ...
            uint16_t c;
            c        = tc16[taddr & 0x7ff];
            color->r = (replicated_rgba[(c) >> 11]);
            color->g = (replicated_rgba[((c) >> 6) & 0x1f]);
            color->b = (replicated_rgba[((c) >> 1) & 0x1f]);
            color->a = (c & 1) ? 0xff : 0;
        } break;
        case 3: {
            taddr = (tbase << 2) + s;
...
static void fetch_texel_entlut(COLOR *color, int s, int t, uint32_t tilenum)
{
    ...
    switch (tile[tilenum].f.tlutswitch) {
        ...
        case 2: {
            ...
            c = TMEM[taddr & 0x7ff];
            c = (s & 1) ? (c & 0xf) : (c >> 4);
            c = ((uint16_t *)(&TMEM[0x800]))[((tpal | c) << 2) ^ 1];
        } break;
        case 3: {
            taddr = (tbase << 3) + s;
            taddr ^= ((t & 1) ? 7 : 3);
                               ...
                               int t1, uint32_t tilenum)
{
    ...
    switch (tile[tilenum].f.notlutswitch) {
        ...
        case 2: {
            ...
            c2        = tc16[taddr2];
            c3        = tc16[taddr3];
            color0->r = (replicated_rgba[(c0) >> 11]);
            color0->g = (replicated_rgba[((c0) >> 6) & 0x1f]);
            color0->b = (replicated_rgba[((c0) >> 1) & 0x1f]);
            color0->a = (c0 & 1) ? 0xff : 0;
            color1->r = (replicated_rgba[(c1) >> 11]);
            color1->g = (replicated_rgba[((c1) >> 6) & 0x1f]);
            color1->b = (replicated_rgba[((c1) >> 1) & 0x1f]);
            color1->a = (c1 & 1) ? 0xff : 0;
            color2->r = (replicated_rgba[(c2) >> 11]);
            color2->g = (replicated_rgba[((c2) >> 6) & 0x1f]);
            color2->b = (replicated_rgba[((c2) >> 1) & 0x1f]);
            color2->a = (c2 & 1) ? 0xff : 0;
            color3->r = (replicated_rgba[(c3) >> 11]);
            color3->g = (replicated_rgba[((c3) >> 6) & 0x1f]);
            color3->b = (replicated_rgba[((c3) >> 1) & 0x1f]);
                                      ...
                                      int t0, int t1, uint32_t tilenum)
{
    ...
    switch (tile[tilenum].f.tlutswitch) {
        ...
        case 2: {
            ...
            c0   = (ands) ? (c0 & 0xf) : (c0 >> 4);
            c0   = ((uint16_t *)(&TMEM[0x800]))[((tpal | c0) << 2) ^ 1];
            c2   = TMEM[taddr2 & 0x7ff];
            c2   = (ands) ? (c2 & 0xf) : (c2 >> 4);
            c2   = ((uint16_t *)(&TMEM[0x800]))[((tpal | c2) << 2) ^ 1];
            ands = s1 & 1;
            c1   = TMEM[taddr1 & 0x7ff];
            c1   = (ands) ? (c1 & 0xf) : (c1 >> 4);
            c1   = ((uint16_t *)(&TMEM[0x800]))[((tpal | c1) << 2) ^ 1];
            c3   = TMEM[taddr3 & 0x7ff];
            c3   = (ands) ? (c3 & 0xf) : (c3 >> 4);
            c3   = ((uint16_t *)(&TMEM[0x800]))[((tpal | c3) << 2) ^ 1];
        } break;
        case 3: {
            taddr0 = ((tbase0 << 3) + s0);
            taddr1 = ((tbase0 << 3) + s1);
        ...
        case 7: {
            ...
            taddr3 ^= xort;
            c0 = TMEM[taddr0 & 0x7ff];
            c0 = ((uint16_t *)(&TMEM[0x800]))[(c0 << 2) ^ 1];
            c2 = TMEM[taddr2 & 0x7ff];
            c2 = ((uint16_t *)(&TMEM[0x800]))[(c2 << 2) ^ 1];
            c1 = TMEM[taddr1 & 0x7ff];
            c1 = ((uint16_t *)(&TMEM[0x800]))[(c1 << 2) ^ 1];
            c3 = TMEM[taddr3 & 0x7ff];
            c3 = ((uint16_t *)(&TMEM[0x800]))[(c3 << 2) ^ 1];
        } break;
        case 8:
        case 9:
        case 10: {
            ...
            c0 = ((uint16_t *)(&TMEM[0x800]))[((c0 >> 6) & ~3) ^ 1];
            c1 = tc16[taddr1 & 0x3ff];
            c1 = ((uint16_t *)(&TMEM[0x800]))[((c1 >> 6) & ~3) ^ 1];
            c2 = tc16[taddr2 & 0x3ff];
            c2 = ((uint16_t *)(&TMEM[0x800]))[((c2 >> 6) & ~3) ^ 1];
            c3 = tc16[taddr3 & 0x3ff];
            c3 = ((uint16_t *)(&TMEM[0x800]))[((c3 >> 6) & ~3) ^ 1];
        } break;
        case 11: {
            taddr0 = ((tbase0 << 3) + s0);
            taddr1 = ((tbase0 << 3) + s1);
...
void get_tmem_idx(int s, int t, uint32_t tilenum, uint32_t *idx0, uint32_t *idx1, uint32_t *idx2, uint32_t *idx3,
                  uint32_t *bit3flipped, uint32_t *hibit)
{
...
void read_tmem_copy(int s, int s1, int s2, int s3, int t, uint32_t tilenum, uint32_t *sortshort, int *hibits,
                    int *lowbits)
{
    uint32_t tbase = (tile[tilenum].line * t) & 0x1ff;
    tbase += tile[tilenum].tmem;
    ...
    short0 = tmem16[sortidx[0] ^ 1];
    short1 = tmem16[sortidx[1] ^ 1];
    short2 = tmem16[sortidx[2] ^ 1];
    short3 = tmem16[sortidx[3] ^ 1];
    ...
    short0 = tmem16[(sortidx[4] | 0x400) ^ 1];
    short1 = tmem16[(sortidx[5] | 0x400) ^ 1];
    short2 = tmem16[(sortidx[6] | 0x400) ^ 1];
    short3 = tmem16[(sortidx[7] | 0x400) ^ 1];
    if (other_modes.en_tlut) {
...
void sort_tmem_shorts_lowhalf(uint32_t *bindshort, uint32_t short0, uint32_t short1, uint32_t short2, uint32_t short3,
                              uint32_t bankno)
{
    switch (bankno) {
        case 0:
...
void replicate_for_copy(uint32_t *outbyte, uint32_t inshort, uint32_t nybbleoffset, uint32_t tilenum, uint32_t tformat,
                        uint32_t tsize)
{
    uint32_t lownib, hinib;
    switch (tsize) {
...
void fetch_qword_copy(uint32_t *hidword, uint32_t *lowdword, int32_t ssss, int32_t ssst, uint32_t tilenum)
{
    ...
    if (other_modes.en_tlut) {
        tsize   = 2;
        tformat = other_modes.tlut_type ? 3 : 0;
    } else {
    ...
    largetex = (tformat == 1 || (tformat == 0 && tsize == 3));
    if (other_modes.en_tlut) {
        shorta = sortshort[4];
        shortb = sortshort[5];
        shortc = sortshort[6];
                                          ...
                                          uint32_t cycle)
{
    ...
    if (other_modes.sample_type) {
        ...
        if (bilerp) {
            ...
            if (!other_modes.mid_texel || sfrac != 0x10 || tfrac != 0x10) {
                ...
                if (!convert) {
                    ...
                    TEX->r =
                        t0.r +
                        ((((sfrac * (t1.r - t0.r)) + (tfrac * (t2.r - t0.r))) + ((invt0r + t3.r) << 6) + 0xc0) >> 8);
                    TEX->g =
                        t0.g +
                        ((((sfrac * (t1.g - t0.g)) + (tfrac * (t2.g - t0.g))) + ((invt0g + t3.g) << 6) + 0xc0) >> 8);
                    TEX->b =
                        t0.b +
                        ((((sfrac * (t1.b - t0.b)) + (tfrac * (t2.b - t0.b))) + ((invt0b + t3.b) << 6) + 0xc0) >> 8);
                    TEX->a =
                        t0.a +
                        ((((sfrac * (t1.a - t0.a)) + (tfrac * (t2.a - t0.a))) + ((invt0a + t3.a) << 6) + 0xc0) >> 8);
                } else {
                    TEX->r =
                        prev->b +
                        ((((prev->r * (t1.r - t0.r)) + (prev->g * (t2.r - t0.r))) + ((invt0r + t3.r) << 6) + 0xc0) >>
                         8);
                    TEX->g =
                        prev->b +
                        ((((prev->r * (t1.g - t0.g)) + (prev->g * (t2.g - t0.g))) + ((invt0g + t3.g) << 6) + 0xc0) >>
                         8);
                    TEX->b =
                        prev->b +
                        ((((prev->r * (t1.b - t0.b)) + (prev->g * (t2.b - t0.b))) + ((invt0b + t3.b) << 6) + 0xc0) >>
                         8);
                    TEX->a =
                        prev->b +
                        ((((prev->r * (t1.a - t0.a)) + (prev->g * (t2.a - t0.a))) + ((invt0a + t3.a) << 6) + 0xc0) >>
                         8);
                }
            }
        } else {
        ...
        if (bilerp) {
            ...
            if (convert)
                t0 = *prev;
            t0.r   = (((t0.r) & ((1 << 9) - 1)) | -((t0.r) & (1 << (9 - 1))));
            t0.g   = (((t0.g) & ((1 << 9) - 1)) | -((t0.g) & (1 << (9 - 1))));
            t0.b   = (((t0.b) & ((1 << 9) - 1)) | -((t0.b) & (1 << (9 - 1))));
            TEX->r = t0.b + ((k0_tf * t0.g + 0x80) >> 8);
            TEX->g = t0.b + ((k1_tf * t0.r + k2_tf * t0.g + 0x80) >> 8);
            TEX->b = t0.b + ((k3_tf * t0.r + 0x80) >> 8);
            TEX->a = t0.b;
                                    ...
                                    int tilenum)
{
    ...
    ss0 = ((ss0) - ((tile[tilenum].sl) << 3));
    st  = ((st) - ((tile[tilenum].tl) << 3));
    ss0 = (ss0 >> 5);
    st  = (st >> 5);
    ss1 = ss0 + 1;
    ss2 = ss0 + 2;
        ...
        if (span[i].validline) {
            ...
            for (j = 0; j <= length; j++) {
                ...
                if (!sigs.startspan) {
                    ...
                    tclod_1cycle_current(&sss, &sst, news, newt, s, t, w, dsinc, dtinc, dwinc, i, prim_tile, &tile1,
                                         &sigs);
                ...
                t += dtinc;
                w += dwinc;
                tclod_1cycle_next(&news, &newt, s, t, w, dsinc, dtinc, dwinc, i, prim_tile, &newtile, &sigs,
                                  &prelodfrac);
        ...
        if (span[i].validline) {
            ...
            for (j = 0; j <= length; j++) {
                ...
                if (!sigs.startspan) {
                    ...
                    tcdiv_ptr(ss, st, sw, &sss, &sst);
                    tclod_2cycle_current(&sss, &sst, news, newt, s, t, w, dsinc, dtinc, dwinc, prim_tile, &tile1,
                                         &tile2);
                    texture_pipeline_cycle(&texel0_color, &texel0_color, sss, sst, tile1, 0);
                ...
                t += dtinc;
                w += dwinc;
                tclod_2cycle_next(&news, &newt, s, t, w, dsinc, dtinc, dwinc, prim_tile, &newtile1, &newtile2,
                                  &prelodfrac);
...
{
    if (__builtin_expect((fb_size == 0), 0)) {
    ...
    for (i = start; i <= end; i++) {
        ...
        if (span[i].validline) {
            if (__builtin_expect((fastkillbits && length >= 0), 0)) {
            ...
            if (__builtin_expect((slowkillbits && length >= 0), 0)) {
                onetimewarnings.fillmbitcrashes = 1;
                rdp_pipeline_crashed            = 1;
                return;
            }
...
{
    int i, j, k;
    if (__builtin_expect((fb_size == 3), 0)) {
        rdp_pipeline_crashed = 1;
        return;
    }
    int tile1     = tilenum;
    ...
    for (i = start; i <= end; i++) {
        if (span[i].validline) {
            ...
            fbptr    = fb_address + ((fb_size) ? (((fb_index) << (fb_size)) >> 1) : (fb_index));
            fbendptr =
                fb_address + ((fb_size) ? ((((fb_width * i + xstart)) << (fb_size)) >> 1) : ((fb_width * i + xstart)));
            length = flip ? (xstart - xendsc) : (xendsc - xstart);
            for (j = 0; j <= length; j += fbadvance) {
                ...
                while (copywmask > 0) {
                    ...
                    if (alphamask & (1 << k)) {
                        {
                            (tempdword) &= 0x007fffff;
                            if ((tempdword) <= plim) {
                                rdram_8[(tempdword)] = (tempbyte);
                                if ((tempdword)&1)
...
void loading_pipeline(int start, int end, int tilenum, int coord_quad, int ltlut)
{
    ...
    if (__builtin_expect((end > start && ltlut), 0)) {
        rdp_pipeline_crashed = 1;
        return;
    }
    if (tile[tilenum].format == 1)
        tmem_formatting = 0;
    else if (tile[tilenum].format == 0 && tile[tilenum].size == 3)
        tmem_formatting = 1;
    else
        tmem_formatting = 2;
    ...
    for (i = start; i <= end; i++) {
        ...
        tiptr    = ti_address + (((ti_index) << (ti_size)) >> 1);
        ...
        for (j = 0; j < length; j += spanadvance) {
            ...
            readidx32 = (tiptr >> 2) & ~1;
            {
                (readidx32) &= (0x007fffff >> 2);
                (readval0) = ((readidx32) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(readidx32)])) : 0;
            };
            readidx32++;
            {
                (readidx32) &= (0x007fffff >> 2);
                (readval1) = ((readidx32) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(readidx32)])) : 0;
            };
            readidx32++;
            {
                (readidx32) &= (0x007fffff >> 2);
                (readval2) = ((readidx32) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(readidx32)])) : 0;
            };
            readidx32++;
            {
                (readidx32) &= (0x007fffff >> 2);
                (readval3) = ((readidx32) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(readidx32)])) : 0;
            };
            switch (tiptr & 7) {
                case 0:
                    if (!ltlut)
            ...
            switch (tmem_formatting) {
                case 0:
                    ...
                    if (bit3fl) {
                        tmem16[tmemidx2 ^ 1]           = (uint16_t)(readval0 >> 16);
                        tmem16[tmemidx3 ^ 1]           = (uint16_t)(readval0 & 0xffff);
                        tmem16[(tmemidx2 | 0x400) ^ 1] = (uint16_t)(readval1 >> 16);
                        tmem16[(tmemidx3 | 0x400) ^ 1] = (uint16_t)(readval1 & 0xffff);
                    } else {
                        tmem16[tmemidx0 ^ 1]           = (uint16_t)(readval0 >> 16);
                        tmem16[tmemidx1 ^ 1]           = (uint16_t)(readval0 & 0xffff);
                        tmem16[(tmemidx0 | 0x400) ^ 1] = (uint16_t)(readval1 >> 16);
                        tmem16[(tmemidx1 | 0x400) ^ 1] = (uint16_t)(readval1 & 0xffff);
                    }
                    break;
                case 1:
                ...
                case 2:
                    if (!dswap) {
                        if (!hibit) {
                            tmem16[tmemidx0 ^ 1] = (uint16_t)(loadqword >> 48);
                            tmem16[tmemidx1 ^ 1] = (uint16_t)(loadqword >> 32);
                            tmem16[tmemidx2 ^ 1] = (uint16_t)(loadqword >> 16);
                            tmem16[tmemidx3 ^ 1] = (uint16_t)(loadqword & 0xffff);
                        } else {
                            tmem16[(tmemidx0 | 0x400) ^ 1] = (uint16_t)(loadqword >> 48);
                            tmem16[(tmemidx1 | 0x400) ^ 1] = (uint16_t)(loadqword >> 32);
                            tmem16[(tmemidx2 | 0x400) ^ 1] = (uint16_t)(loadqword >> 16);
                            tmem16[(tmemidx3 | 0x400) ^ 1] = (uint16_t)(loadqword & 0xffff);
                        }
                    } else {
                        if (!hibit) {
                            tmem16[tmemidx0 ^ 1] = (uint16_t)(loadqword >> 16);
                            tmem16[tmemidx1 ^ 1] = (uint16_t)(loadqword & 0xffff);
                            tmem16[tmemidx2 ^ 1] = (uint16_t)(loadqword >> 48);
                            tmem16[tmemidx3 ^ 1] = (uint16_t)(loadqword >> 32);
                        } else {
                            tmem16[(tmemidx0 | 0x400) ^ 1] = (uint16_t)(loadqword >> 16);
                            tmem16[(tmemidx1 | 0x400) ^ 1] = (uint16_t)(loadqword & 0xffff);
                            tmem16[(tmemidx2 | 0x400) ^ 1] = (uint16_t)(loadqword >> 48);
                            tmem16[(tmemidx3 | 0x400) ^ 1] = (uint16_t)(loadqword >> 32);
                        }
                    }
                    break;
            }
...
static void edgewalker_for_prims(int32_t *ewdata)
{
    ...
    if (__builtin_expect((other_modes.f.stalederivs), 0)) {
        deduce_derivatives();
    ...
    yl          = (((ewdata[0]) & ((1 << 14) - 1)) | -((ewdata[0]) & (1 << (14 - 1))));
    ym          = ewdata[1] >> 16;
    ym          = (((ym) & ((1 << 14) - 1)) | -((ym) & (1 << (14 - 1))));
    yh          = (((ewdata[1]) & ((1 << 14) - 1)) | -((ewdata[1]) & (1 << (14 - 1))));
    xl          = (((ewdata[2]) & ((1 << 28) - 1)) | -((ewdata[2]) & (1 << (28 - 1))));
    xh          = (((ewdata[4]) & ((1 << 28) - 1)) | -((ewdata[4]) & (1 << (28 - 1))));
    xm          = (((ewdata[6]) & ((1 << 28) - 1)) | -((ewdata[6]) & (1 << (28 - 1))));
    dxldy       = (((ewdata[3]) & ((1 << 30) - 1)) | -((ewdata[3]) & (1 << (30 - 1))));
    dxhdy       = (((ewdata[5]) & ((1 << 30) - 1)) | -((ewdata[5]) & (1 << (30 - 1))));
    dxmdy       = (((ewdata[7]) & ((1 << 30) - 1)) | -((ewdata[7]) & (1 << (30 - 1))));
    ...
    spans_dady  = dady >> 14;
    spans_dzdy  = dzdy >> 10;
    spans_drdy  = (((spans_drdy) & ((1 << 13) - 1)) | -((spans_drdy) & (1 << (13 - 1))));
    spans_dgdy  = (((spans_dgdy) & ((1 << 13) - 1)) | -((spans_dgdy) & (1 << (13 - 1))));
    spans_dbdy  = (((spans_dbdy) & ((1 << 13) - 1)) | -((spans_dbdy) & (1 << (13 - 1))));
    spans_dady  = (((spans_dady) & ((1 << 13) - 1)) | -((spans_dady) & (1 << (13 - 1))));
    spans_dzdy  = (((spans_dzdy) & ((1 << 22) - 1)) | -((spans_dzdy) & (1 << (22 - 1))));
    spans_cdr   = spans_dr >> 14;
    spans_cdr   = (((spans_cdr) & ((1 << 13) - 1)) | -((spans_cdr) & (1 << (13 - 1))));
    spans_cdg   = spans_dg >> 14;
    spans_cdg   = (((spans_cdg) & ((1 << 13) - 1)) | -((spans_cdg) & (1 << (13 - 1))));
    spans_cdb   = spans_db >> 14;
    spans_cdb   = (((spans_cdb) & ((1 << 13) - 1)) | -((spans_cdb) & (1 << (13 - 1))));
    spans_cda   = spans_da >> 14;
    spans_cda   = (((spans_cda) & ((1 << 13) - 1)) | -((spans_cda) & (1 << (13 - 1))));
    spans_cdz   = spans_dz >> 10;
    spans_cdz   = (((spans_cdz) & ((1 << 22) - 1)) | -((spans_cdz) & (1 << (22 - 1))));
    ...
    if (flip) {
        for (k = ycur; k <= ylfar; k++) {
            ...
            if (k >= yhclose) {
                ...
                if (spix == ldflag) {
                    span[j].unscrx = (((xright >> 16) & ((1 << 12) - 1)) | -((xright >> 16) & (1 << (12 - 1))));
                    xfrac          = (xright >> 8) & 0xff;
                    {
                ...
                if (spix == 3) {
                    ...
                    span[j].rx = minxhx;
                    span[j].validline =
                        !allinval && !allover && !allunder && (!scfield || (scfield && !(sckeepodd ^ (j & 1))));
                }
            }
            if (spix == 3) {
                {
    ...
    switch (other_modes.cycle_type) {
        case 0:
            render_spans_1cycle_ptr(yhlimit >> 2, yllimit >> 2, tilenum, flip);
            break;
        case 1:
            render_spans_2cycle_ptr(yhlimit >> 2, yllimit >> 2, tilenum, flip);
            break;
        case 2:
...
static void edgewalker_for_loads(int32_t *lewdata)
{
    ...
    yl                  = (((lewdata[0]) & ((1 << 14) - 1)) | -((lewdata[0]) & (1 << (14 - 1))));
    ym                  = lewdata[1] >> 16;
    ym                  = (((ym) & ((1 << 14) - 1)) | -((ym) & (1 << (14 - 1))));
    yh                  = (((lewdata[1]) & ((1 << 14) - 1)) | -((lewdata[1]) & (1 << (14 - 1))));
    xl                  = (((lewdata[2]) & ((1 << 28) - 1)) | -((lewdata[2]) & (1 << (28 - 1))));
    xh                  = (((lewdata[3]) & ((1 << 28) - 1)) | -((lewdata[3]) & (1 << (28 - 1))));
    xm                  = (((lewdata[4]) & ((1 << 28) - 1)) | -((lewdata[4]) & (1 << (28 - 1))));
    dxldy               = 0;
    dxhdy               = 0;
    dxmdy               = 0;
...
static const uint32_t rdp_command_length[64] = {8,
                                                8,
                                                8,
                                                8,
                                                8,
...
static int rdp_dasm(char *buffer)
{
    ...
    switch (command) {
        case 0x00:
            sprintf(buffer, "No Op");
            break;
        case 0x08:
            sprintf(buffer, "Tri_NoShade (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0a:
            sprintf(buffer, "Tri_Tex (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0c:
            sprintf(buffer, "Tri_Shade (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0e:
            sprintf(buffer, "Tri_TexShade (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x09:
            sprintf(buffer, "TriZ_NoShade (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0b:
            sprintf(buffer, "TriZ_Tex (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0d:
            sprintf(buffer, "TriZ_Shade (%08X %08X)", cmd[0], cmd[1]);
            break;
        case 0x0f:
            sprintf(buffer, "TriZ_TexShade (%08X %08X)", cmd[0], cmd[1]);
            break;
        ...
        case 0x25: {
            ...
            if (command == 0x24)
                sprintf(buffer, "Texture_Rectangle      %d, %s, %s, %s, %s,  %s, %s, %s, %s", tile, sh, th, sl, tl, s,
                        t, dsdx, dtdy);
            else
                sprintf(buffer, "Texture_Rectangle_Flip %d, %s, %s, %s, %s,  %s, %s, %s, %s", tile, sh, th, sl, tl, s,
                        t, dsdx, dtdy);
            break;
        }
        case 0x26:
            sprintf(buffer, "Sync_Load");
            break;
        case 0x27:
            sprintf(buffer, "Sync_Pipe");
            break;
        case 0x28:
            sprintf(buffer, "Sync_Tile");
            break;
        case 0x29:
            sprintf(buffer, "Sync_Full");
            break;
        case 0x2a:
            sprintf(buffer, "Set_Key_GB");
            break;
        case 0x2b:
            sprintf(buffer, "Set_Key_R");
            break;
        case 0x2c:
            sprintf(buffer, "Set_Convert");
            break;
        case 0x2d:
            sprintf(buffer, "Set_Scissor            %s, %s, %s, %s", sl, tl, sh, th);
            break;
        case 0x2e:
            sprintf(buffer, "Set_Prim_Depth         %04X, %04X", (cmd[1] >> 16) & 0xffff, cmd[1] & 0xffff);
            break;
        case 0x2f:
            sprintf(buffer, "Set_Other_Modes        %08X %08X", cmd[0], cmd[1]);
            break;
        case 0x30:
            sprintf(buffer, "Load_TLUT              %d, %s, %s, %s, %s", tile, sl, tl, sh, th);
            break;
        case 0x32:
            sprintf(buffer, "Set_Tile_Size          %d, %s, %s, %s, %s", tile, sl, tl, sh, th);
            break;
        case 0x33:
            sprintf(buffer, "Load_Block             %d, %03X, %03X, %03X, %03X", tile, (cmd[0] >> 12) & 0xfff,
                    cmd[0] & 0xfff, (cmd[1] >> 12) & 0xfff, cmd[1] & 0xfff);
            break;
        case 0x34:
            sprintf(buffer, "Load_Tile              %d, %s, %s, %s, %s", tile, sl, tl, sh, th);
            break;
        case 0x35:
            sprintf(buffer, "Set_Tile               %d, %s, %s, %d, %04X", tile, format, size,
                    ((cmd[0] >> 9) & 0x1ff) * 8, (cmd[0] & 0x1ff) * 8);
            break;
        case 0x36:
            sprintf(buffer, "Fill_Rectangle         %s, %s, %s, %s", sh, th, sl, tl);
            break;
        case 0x37:
            sprintf(buffer, "Set_Fill_Color         R: %d, G: %d, B: %d, A: %d", r, g, b, a);
            break;
        case 0x38:
            sprintf(buffer, "Set_Fog_Color          R: %d, G: %d, B: %d, A: %d", r, g, b, a);
            break;
        case 0x39:
            sprintf(buffer, "Set_Blend_Color        R: %d, G: %d, B: %d, A: %d", r, g, b, a);
            break;
        case 0x3a:
            sprintf(buffer, "Set_Prim_Color         %d, %d, R: %d, G: %d, B: %d, A: %d", (cmd[0] >> 8) & 0x1f,
                    cmd[0] & 0xff, r, g, b, a);
            break;
        case 0x3b:
            sprintf(buffer, "Set_Env_Color          R: %d, G: %d, B: %d, A: %d", r, g, b, a);
            break;
        case 0x3c:
            sprintf(buffer, "Set_Combine            %08X %08X", cmd[0], cmd[1]);
            break;
        case 0x3d:
            sprintf(buffer, "Set_Texture_Image      %s, %s, %d, %08X", format, size, (cmd[0] & 0x1ff) + 1, cmd[1]);
            break;
        case 0x3e:
            sprintf(buffer, "Set_Mask_Image         %08X", cmd[1]);
            break;
        case 0x3f:
            sprintf(buffer, "Set_Color_Image        %s, %s, %d, %08X", format, size, (cmd[0] & 0x1ff) + 1, cmd[1]);
            break;
        default:
            sprintf(buffer, "Unknown command 0x%06X (%08X %08X)", command, cmd[0], cmd[1]);
            break;
    }
...
static void rdp_tex_rect(uint32_t w1, uint32_t w2)
{
    ...
    dsdx = ((int16_t)(dsdx));
    dtdy = ((int16_t)(dtdy));
    if (other_modes.cycle_type == 3 || other_modes.cycle_type == 2)
        yl |= 3;
    xlint = (xl >> 2) & 0x3ff;
    xhint = (xh >> 2) & 0x3ff;
    int32_t ewdata[44];
...
{
    z64gl_command = 0;
    g_vr4300->signal_rcp_interrupt(MI_INTR_DP);
}
...
static void rdp_set_convert(uint32_t w1, uint32_t w2)
{
    ...
    k0_tf      = ((((k0) & ((1 << 9) - 1)) | -((k0) & (1 << (9 - 1)))) << 1) + 1;
    k1_tf      = ((((k1) & ((1 << 9) - 1)) | -((k1) & (1 << (9 - 1)))) << 1) + 1;
    k2_tf      = ((((k2) & ((1 << 9) - 1)) | -((k2) & (1 << (9 - 1)))) << 1) + 1;
    k3_tf      = ((((k3) & ((1 << 9) - 1)) | -((k3) & (1 << (9 - 1)))) << 1) + 1;
    k4         = (w2 >> 9) & 0x1ff;
    k5         = w2 & 0x1ff;
}
...
static void rdp_set_other_modes(uint32_t w1, uint32_t w2)
{
    ...
    SET_BLENDER_INPUT(0, 0, &blender1a_r[0], &blender1a_g[0], &blender1a_b[0], &blender1b_a[0], other_modes.blend_m1a_0,
                      other_modes.blend_m1b_0);
    SET_BLENDER_INPUT(0, 1, &blender2a_r[0], &blender2a_g[0], &blender2a_b[0], &blender2b_a[0], other_modes.blend_m2a_0,
                      other_modes.blend_m2b_0);
    SET_BLENDER_INPUT(1, 0, &blender1a_r[1], &blender1a_g[1], &blender1a_b[1], &blender1b_a[1], other_modes.blend_m1a_1,
                      other_modes.blend_m1b_1);
    SET_BLENDER_INPUT(1, 1, &blender2a_r[1], &blender2a_g[1], &blender2a_b[1], &blender2b_a[1], other_modes.blend_m2a_1,
                      other_modes.blend_m2b_1);
    other_modes.f.stalederivs = 1;
}
void deduce_derivatives()
{
    ...
    other_modes.f.realblendershiftersneeded = (other_modes.f.special_bsel0 && other_modes.cycle_type == 0) ||
                                              (other_modes.f.special_bsel1 && other_modes.cycle_type == 1);
    other_modes.f.interpixelblendershiftersneeded = (other_modes.f.special_bsel0 && other_modes.cycle_type == 1);
    ...
    if (combiner_rgbmul_r[1] == &texel1_color.r || combiner_rgbsub_a_r[1] == &texel1_color.r ||
        combiner_rgbsub_b_r[1] == &texel1_color.r || combiner_rgbadd_r[1] == &texel1_color.r ||
        combiner_alphamul[1] == &texel1_color.a || combiner_alphasub_a[1] == &texel1_color.a ||
        combiner_alphasub_b[1] == &texel1_color.a || combiner_alphaadd[1] == &texel1_color.a ||
        combiner_rgbmul_r[1] == &texel1_color.a)
        texel1_used_in_cc1 = 1;
    if (combiner_rgbmul_r[1] == &texel0_color.r || combiner_rgbsub_a_r[1] == &texel0_color.r ||
        combiner_rgbsub_b_r[1] == &texel0_color.r || combiner_rgbadd_r[1] == &texel0_color.r ||
        combiner_alphamul[1] == &texel0_color.a || combiner_alphasub_a[1] == &texel0_color.a ||
        combiner_alphasub_b[1] == &texel0_color.a || combiner_alphaadd[1] == &texel0_color.a ||
        combiner_rgbmul_r[1] == &texel0_color.a)
        texel0_used_in_cc1 = 1;
    if (combiner_rgbmul_r[0] == &texel1_color.r || combiner_rgbsub_a_r[0] == &texel1_color.r ||
        combiner_rgbsub_b_r[0] == &texel1_color.r || combiner_rgbadd_r[0] == &texel1_color.r ||
        combiner_alphamul[0] == &texel1_color.a || combiner_alphasub_a[0] == &texel1_color.a ||
        combiner_alphasub_b[0] == &texel1_color.a || combiner_alphaadd[0] == &texel1_color.a ||
        combiner_rgbmul_r[0] == &texel1_color.a)
        texel1_used_in_cc0 = 1;
    if (combiner_rgbmul_r[0] == &texel0_color.r || combiner_rgbsub_a_r[0] == &texel0_color.r ||
        combiner_rgbsub_b_r[0] == &texel0_color.r || combiner_rgbadd_r[0] == &texel0_color.r ||
        combiner_alphamul[0] == &texel0_color.a || combiner_alphasub_a[0] == &texel0_color.a ||
        combiner_alphasub_b[0] == &texel0_color.a || combiner_alphaadd[0] == &texel0_color.a ||
    ...
    int lodfracused = 0;
    if ((other_modes.cycle_type == 1 && (lod_frac_used_in_cc0 || lod_frac_used_in_cc1)) ||
        (other_modes.cycle_type == 0 && lod_frac_used_in_cc1))
        lodfracused = 1;
    if ((other_modes.cycle_type == 0 && combiner_rgbsub_a_r[1] == &noise) ||
        (other_modes.cycle_type == 1 && (combiner_rgbsub_a_r[0] == &noise || combiner_rgbsub_a_r[1] == &noise)) ||
...
static void (*const rdp_command_table[64])(uint32_t w1, uint32_t w2) = {
    rdp_noop,           rdp_invalid,           rdp_invalid,         rdp_invalid,        rdp_invalid,
    rdp_invalid,        rdp_invalid,           rdp_invalid,         rdp_tri_noshade,    rdp_tri_noshade_z,
    rdp_tri_tex,        rdp_tri_tex_z,         rdp_tri_shade,       rdp_tri_shade_z,    rdp_tri_texshade,
    rdp_tri_texshade_z, rdp_invalid,           rdp_invalid,         rdp_invalid,        rdp_invalid,
    rdp_invalid,        rdp_invalid,           rdp_invalid,         rdp_invalid,        rdp_invalid,
    rdp_invalid,        rdp_invalid,           rdp_invalid,         rdp_invalid,        rdp_invalid,
    rdp_invalid,        rdp_invalid,           rdp_invalid,         rdp_invalid,        rdp_invalid,
    rdp_invalid,        rdp_tex_rect,          rdp_tex_rect_flip,   rdp_sync_load,      rdp_sync_pipe,
    rdp_sync_tile,      rdp_sync_full,         rdp_set_key_gb,      rdp_set_key_r,      rdp_set_convert,
    rdp_set_scissor,    rdp_set_prim_depth,    rdp_set_other_modes, rdp_load_tlut,      rdp_invalid,
    rdp_set_tile_size,  rdp_load_block,        rdp_load_tile,       rdp_set_tile,       rdp_fill_rect,
    rdp_set_fill_color, rdp_set_fog_color,     rdp_set_blend_color, rdp_set_prim_color, rdp_set_env_color,
    rdp_set_combine,    rdp_set_texture_image, rdp_set_mask_image,  rdp_set_color_image};
void rdp_process_list(void)
{
    int      i, length;
    uint32_t cmd, cmd_length;
    uint32_t dp_current_al = (n64->rdp.regs[DPC_CURRENT_REG]) & ~7, dp_end_al = (n64->rdp.regs[DPC_END_REG]) & ~7;
    (n64->rdp.regs[DPC_STATUS_REG]) &= ~0x02;
    ...
    while (remaining_length) {
        ...
        if ((n64->rdp.regs[DPC_STATUS_REG]) & 0x01) {
            for (i = 0; i < toload; i++) {
                rdp_cmd_data[rdp_cmd_ptr] = byteswap_32(((uint32_t *)n64->rsp.mem)[dp_current_al & 0x3ff]);
                rdp_cmd_ptr++;
                dp_current_al++;
            }
        } else {
            for (i = 0; i < toload; i++) {
                {
                    (dp_current_al) &= (0x007fffff >> 2);
                    (rdp_cmd_data[rdp_cmd_ptr]) =
                        ((dp_current_al) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(dp_current_al)])) : 0;
                };
                rdp_cmd_ptr++;
                dp_current_al++;
            }
        ...
        while (rdp_cmd_cur < rdp_cmd_ptr && !rdp_pipeline_crashed) {
            ...
            if ((rdp_cmd_ptr - rdp_cmd_cur) < cmd_length) {
                if (!remaining_length) {
                    (n64->rdp.regs[DPC_START_REG]) &= 0x00FFFFFF;
                    (n64->rdp.regs[DPC_END_REG]) &= 0x00FFFFFF;
                    (n64->rdp.regs[DPC_CURRENT_REG]) = (n64->rdp.regs[DPC_END_REG]);
                    return;
                } else {
    ...
    (n64->rdp.regs[DPC_END_REG]) &= 0x00FFFFFF;
    (n64->rdp.regs[DPC_CURRENT_REG]) = (n64->rdp.regs[DPC_END_REG]);
    (n64->rdp.regs[DPC_STATUS_REG]) |= 0x080;
}
static inline int alpha_compare(int32_t comb_alpha)
{
    int32_t threshold;
                       ...
                       uint32_t curpixel_memcvg)
{
    ...
    hval = finalcvg & 3;
    {
        (fb) &= (0x007fffff >> 1);
        if ((fb) <= idxlim16) {
            rdram_16[(fb)]    = ((uint16_t)(((uint8_t)(rval >> 8)) | ((uint16_t)(rval << 8))));
            hidden_bits[(fb)] = (hval);
        }
    };
}
                       ...
                       uint32_t curpixel_memcvg)
{
    ...
    finalcolor |= (finalcvg << 5);
    {
        (fb) &= (0x007fffff >> 2);
        if ((fb) <= idxlim32) {
            ((uint32_t *)n64->ri.ram)[(fb)] = byteswap_32(finalcolor);
            hidden_bits[(fb) << 1]          = ((g & 1) ? 3 : 0);
            hidden_bits[((fb) << 1) + 1]    = (0);
        }
    };
}
static void fbfill_4(uint32_t curpixel)
...
static void fbfill_16(uint32_t curpixel)
{
    ...
    hval = ((val & 1) << 1) | (val & 1);
    {
        (fb) &= (0x007fffff >> 1);
        if ((fb) <= idxlim16) {
            rdram_16[(fb)]    = ((uint16_t)(((uint8_t)(val >> 8)) | ((uint16_t)(val << 8))));
            hidden_bits[(fb)] = (hval);
        }
    };
}
static void fbfill_32(uint32_t curpixel)
{
    uint32_t fb = (fb_address >> 2) + curpixel;
    {
        (fb) &= (0x007fffff >> 2);
        if ((fb) <= idxlim32) {
            ((uint32_t *)n64->ri.ram)[(fb)] = byteswap_32(fill_color);
    ...
    if (other_modes.image_read_en) {
        {
            (addr) &= (0x007fffff >> 1);
            if ((addr) <= idxlim16) {
                (fword) = ((uint16_t)(((uint8_t)(rdram_16[(addr)] >> 8)) | ((uint16_t)(rdram_16[(addr)] << 8))));
        ...
        if (fb_format == 0) {
            memory_color.r = (((fword) >> 8) & 0xf8);
            memory_color.g = (((fword)&0x7c0) >> 3);
            memory_color.b = (((fword)&0x3e) << 2);
        ...
        *curpixel_memcvg = lowbits;
    ...
    } else {
        {
            (addr) &= (0x007fffff >> 1);
            (fword) = ((addr) <= idxlim16)
                          ? (((uint16_t)(((uint8_t)(rdram_16[(addr)] >> 8)) | ((uint16_t)(rdram_16[(addr)] << 8)))))
                          : 0;
        };
        if (fb_format == 0) {
            memory_color.r = (((fword) >> 8) & 0xf8);
...
static void fbread2_16(uint32_t curpixel, uint32_t *curpixel_memcvg)
{
    ...
    if (other_modes.image_read_en) {
        ...
        if (fb_format == 0) {
            pre_memory_color.r = (((fword) >> 8) & 0xf8);
            pre_memory_color.g = (((fword)&0x7c0) >> 3);
            pre_memory_color.b = (((fword)&0x3e) << 2);
            lowbits            = ((fword & 1) << 2) | hbyte;
        } else {
...
static void fbread_32(uint32_t curpixel, uint32_t *curpixel_memcvg)
{
    ...
    {
        (addr) &= (0x007fffff >> 2);
        (mem) = ((addr) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[(addr)])) : 0;
    };
...
static inline void z_store(uint32_t zcurpixel, uint32_t z, int dzpixenc)
{
    ...
    {
        (zcurpixel) &= (0x007fffff >> 1);
        if ((zcurpixel) <= idxlim16) {
            rdram_16[(zcurpixel)]    = ((uint16_t)(((uint8_t)(zval >> 8)) | ((uint16_t)(zval << 8))));
    ...
    if (other_modes.z_compare_en) {
        {
            ...
            if ((zcurpixel) <= idxlim16) {
                (zval) =
                    ((uint16_t)(((uint8_t)(rdram_16[(zcurpixel)] >> 8)) | ((uint16_t)(rdram_16[(zcurpixel)] << 8))));
...
static inline void video_filter16(int *endr, int *endg, int *endb, uint32_t fboffset, uint32_t num, uint32_t hres,
                                  uint32_t centercvg, uint32_t fetchbugstate)
{
    ...
    {
        {
            ((leftup)) &= (0x007fffff >> 1);
            if (((leftup)) <= idxlim16) {
                (pix) = ((uint16_t)(((uint8_t)(rdram_16[((leftup))] >> 8)) | ((uint16_t)(rdram_16[((leftup))] << 8))));
                (hidval) = hidden_bits[((leftup))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
        if (hidval == 3 && (pix & 1)) {
            backr[numoffull] = (((pix) >> 8) & 0xf8);
            backg[numoffull] = (((pix)&0x7c0) >> 3);
            backb[numoffull] = (((pix)&0x3e) << 2);
            numoffull++;
        }
    };
    {
        {
            ((rightup)) &= (0x007fffff >> 1);
            if (((rightup)) <= idxlim16) {
                (pix) =
                    ((uint16_t)(((uint8_t)(rdram_16[((rightup))] >> 8)) | ((uint16_t)(rdram_16[((rightup))] << 8))));
                (hidval) = hidden_bits[((rightup))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
    ...
    {
        {
            ((toleft)) &= (0x007fffff >> 1);
            if (((toleft)) <= idxlim16) {
                (pix) = ((uint16_t)(((uint8_t)(rdram_16[((toleft))] >> 8)) | ((uint16_t)(rdram_16[((toleft))] << 8))));
                (hidval) = hidden_bits[((toleft))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
    ...
    {
        {
            ((toright)) &= (0x007fffff >> 1);
            if (((toright)) <= idxlim16) {
                (pix) =
                    ((uint16_t)(((uint8_t)(rdram_16[((toright))] >> 8)) | ((uint16_t)(rdram_16[((toright))] << 8))));
                (hidval) = hidden_bits[((toright))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
    ...
    {
        {
            ((leftdown)) &= (0x007fffff >> 1);
            if (((leftdown)) <= idxlim16) {
                (pix) =
                    ((uint16_t)(((uint8_t)(rdram_16[((leftdown))] >> 8)) | ((uint16_t)(rdram_16[((leftdown))] << 8))));
                (hidval) = hidden_bits[((leftdown))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
    ...
    {
        {
            ((rightdown)) &= (0x007fffff >> 1);
            if (((rightdown)) <= idxlim16) {
                (pix)    = ((uint16_t)(((uint8_t)(rdram_16[((rightdown))] >> 8)) |
                                    ((uint16_t)(rdram_16[((rightdown))] << 8))));
                (hidval) = hidden_bits[((rightdown))];
            } else {
                (pix) = (hidval) = 0;
            }
        };
                                  ...
                                  uint32_t centercvg, uint32_t fetchbugstate)
{
...

    {
        {
            ((leftup)) &= (0x007fffff >> 2);
            (pix) = (((leftup)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((leftup))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
    ...
    {
        {
            ((rightup)) &= (0x007fffff >> 2);
            (pix) = (((rightup)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((rightup))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
            backr[numoffull] = (pix >> 24) & 0xff;
    ...
    };
    {
        {
            ((toleft)) &= (0x007fffff >> 2);
            (pix) = (((toleft)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((toleft))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
            backr[numoffull] = (pix >> 24) & 0xff;
    ...
    {
        {
            ((toright)) &= (0x007fffff >> 2);
            (pix) = (((toright)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((toright))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
            backr[numoffull] = (pix >> 24) & 0xff;
    ...
    {
        {
            ((leftdown)) &= (0x007fffff >> 2);
            (pix) = (((leftdown)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((leftdown))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
            backr[numoffull] = (pix >> 24) & 0xff;
    ...
    {
        {
            ((rightdown)) &= (0x007fffff >> 2);
            (pix) = (((rightdown)) <= idxlim32) ? (byteswap_32(((uint32_t *)n64->ri.ram)[((rightdown))])) : 0;
        };
        pixcvg = (pix >> 5) & 7;
        if (pixcvg == 7) {
            backr[numoffull] = (pix >> 24) & 0xff;
                                    ...
                                    uint32_t fetchbugstate)
{
    ...
    if (maxpix <= idxlim16 && leftuppix <= idxlim16) {
        {
            addr  = (leftuppix);
            pix   = ((uint16_t)(((uint8_t)(rdram_16[addr] >> 8)) | ((uint16_t)(rdram_16[addr] << 8))));
            tempr = (pix >> 11) & 0x1f;
            tempg = (pix >> 6) & 0x1f;
            tempb = (pix >> 1) & 0x1f;
            rend += redptr[tempr];
                                    ...
                                    uint32_t fetchbugstate)
{
    ...
    if (maxpix <= idxlim32 && leftuppix <= idxlim32) {
        {
            addr  = (leftuppix);
            pix   = byteswap_32(((uint32_t *)n64->ri.ram)[addr]);
            tempr = (pix >> 27) & 0x1f;
            tempg = (pix >> 19) & 0x1f;
            tempb = (pix >> 11) & 0x1f;
            rend += redptr[tempr];
...
static void tcdiv_nopersp(int32_t ss, int32_t st, int32_t sw, int32_t *sss, int32_t *sst)
{
    *sss = (((int16_t)(ss))) & 0x1ffff;
    *sst = (((int16_t)(st))) & 0x1ffff;
}
static void tcdiv_persp(int32_t ss, int32_t st, int32_t sw, int32_t *sss, int32_t *sst)
{
    int     w_carry = 0;
    ...
    tlu_rcp = shift >> 4;
    shift &= 0xf;
    sprod         = ((int16_t)(ss)) * tlu_rcp;
    tprod         = ((int16_t)(st)) * tlu_rcp;
...
static inline void tclod_4x17_to_15(int32_t scurr, int32_t snext, int32_t tcurr, int32_t tnext, int32_t previous,
                                    int32_t *lod)
{
    int dels = (((snext) & ((1 << 17) - 1)) | -((snext) & (1 << (17 - 1)))) -
               (((scurr) & ((1 << 17) - 1)) | -((scurr) & (1 << (17 - 1))));
    if (dels & 0x20000)
        dels = ~dels & 0x1ffff;
    int delt = (((tnext) & ((1 << 17) - 1)) | -((tnext) & (1 << (17 - 1)))) -
               (((tcurr) & ((1 << 17) - 1)) | -((tcurr) & (1 << (17 - 1))));
    if (delt & 0x20000)
        delt = ~delt & 0x1ffff;
